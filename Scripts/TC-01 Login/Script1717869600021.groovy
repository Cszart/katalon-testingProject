...
WebUI.verifyElementVisible(findTestObject('Object Repository/Page_Logged In Successfully/h1_Logged In Successfully'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_Logged In Successfully/a_Log out'))

WebUI.click(findTestObject('Object Repository/Page_Logged In Successfully/a_Log out'))
